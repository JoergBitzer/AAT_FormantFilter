...
//==============================================================================
FormantFilterAudioProcessor::FormantFilterAudioProcessor()
                       ...
                       ),m_algo(this), m_parameterVTS(nullptr)
{
    ...
    m_parameterVTS = std::make_unique<AudioProcessorValueTreeState>(*this, nullptr, Identifier("FormantFilterVTS"),
...
//==============================================================================
const juce::String FormantFilterAudioProcessor::getName() const
{
    return JucePlugin_Name;
}

bool FormantFilterAudioProcessor::acceptsMidi() const
{
...
bool FormantFilterAudioProcessor::producesMidi() const
{
...
bool FormantFilterAudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
double FormantFilterAudioProcessor::getTailLengthSeconds() const
{

    return 0.0;
}

int FormantFilterAudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int FormantFilterAudioProcessor::getCurrentProgram()
{
    return 0;
}

void FormantFilterAudioProcessor::setCurrentProgram (int index)
{
    juce::ignoreUnused (index);
}

const juce::String FormantFilterAudioProcessor::getProgramName (int index)
{
    juce::ignoreUnused (index);
    return {};
}

void FormantFilterAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
    juce::ignoreUnused (index, newName);
}

//==============================================================================
void FormantFilterAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
void FormantFilterAudioProcessor::releaseResources()
{
    // When playback stops, you can use this as an opportunity to free up any
    // spare memory, etc.
}

bool FormantFilterAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
void FormantFilterAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer,
...
//==============================================================================
bool FormantFilterAudioProcessor::hasEditor() const
{
    return true; // (change this to false if you choose to not supply an editor)
}

juce::AudioProcessorEditor* FormantFilterAudioProcessor::createEditor()
{
    return new FormantFilterAudioProcessorEditor (*this);
}

//==============================================================================
void FormantFilterAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
...
void FormantFilterAudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
...
{
    return new FormantFilterAudioProcessor();
}
